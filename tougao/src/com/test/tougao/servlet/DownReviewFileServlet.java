...
public class DownReviewFileServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		DocReviewedDao dao=new DocReviewedDao();
		DocReviewed docreviewed=null;
		String fname ="";
			
		//String downpath=request.getRealPath("/upfile");//这种方法过已过时
		String downpath = getServletContext().getRealPath("/")+"reviewfile"+"\\";
		System.out.println("下载文件路径："+downpath);
		try 
		{ 
			docreviewed=dao.findById(fileid);
			fname=docreviewed.getDiskName();
