...
public class DownReviewPaperServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ReviewedDao dao=new ReviewedDao();
		Reviewed reviewed=null;
		String fname ="";
			
		//String downpath=request.getRealPath("/upfile");//这种方法过已过时
		String downpath = getServletContext().getRealPath("/")+"reviewpaper"+"\\";
		System.out.println("下载文件路径："+downpath);
		try 
		{ 
			reviewed=dao.findById(fileid);
			fname=reviewed.getDiskName();
