...
import com.test.tougao.dao.DocFileDao;
...
public class DownloadFileServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		DocFileDao dao=new DocFileDao();
		DocFile docfile=null;
		String fname ="";
			
		//String downpath=request.getRealPath("/upfile");//这种方法过已过时
		String downpath = getServletContext().getRealPath("/")+"uploadfiles"+"\\";
		System.out.println("下载文件路径："+downpath);
		try 
		{ 
			docfile=dao.findById(fileid);
			fname=docfile.getDiskId();
