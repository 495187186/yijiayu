...
import com.test.tougao.dao.StudentUpfileDao;
...
public class FileDownServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		StudentUpfileDao dao=new StudentUpfileDao();
		StudentUpfile upfile=null;
		String fname ="";
			
		//String downpath=request.getRealPath("/upfile");//这种方法过已过时
		String downpath = getServletContext().getRealPath("/")+"upfile"+"\\";
		System.out.println("下载文件路径："+downpath);
		try 
		{ 
			upfile=dao.findById(fileid);
			fname=upfile.getDiskId();
