...
function checkForm() 
{
  ...
  <body>
    ...
    %>
    <form name="addnote" method="post"  action="Add2NoteServlet" enctype="multipart/form-data">
      <br>
               ...
               <table width="96%"  border="0" align="center" cellspacing="1" bgcolor="#CCCCCC" class="pt_12_hei">
                  <tr class="kbj">
                     ...
                     <td width="86%" bgcolor="#d5f1f2">　 
                       <input type = "text" name = "notename" id = "notename" size="35" title="留言主题字数不超过30字">
                  ...
                  <tr class="kbj">
                     ...
                     <td width="86%" bgcolor="#d5f1f2">　 
                       ...
                       (注:<FONT color=#ff0000>若有多个文件，请打包一起上传。</FONT>)
                     </td>
                  </tr>
