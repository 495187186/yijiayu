  ...
  <body>
    ...
    %>
       ...
       %>
           ...
           <a href="admin/main.jsp?page=<%="1" %>">首页 </a>&nbsp;&nbsp;
        <%
           if(currentPage>1){
        %>
           <a href="admin/main.jsp?page=<%=currentPage-1%>">上一页</a>
        <%
           }else{
        %>
                             上一页
        ...
        %>
           <a href="admin/main.jsp?page=<%=currentPage+1 %>">下一页 </a>
        <%
           }else{
        %>
                             下一页 
        ...
        %>
          &nbsp;&nbsp;
          <a href="admin/main.jsp?page=<%=totalPage %>">尾页 </a>
       <%
        }
       %>
       </center>
