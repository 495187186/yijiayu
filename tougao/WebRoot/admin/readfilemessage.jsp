...
<html>
  <head>
    ...
    <title>My JSP 'readfilemessage.jsp' starting page</title>
...
function checkForm() 
{
  ...
  <body>
    <%
       ...
       list = filemessageDao.findReadMessage(no,"1");//查询该用户的未读留言
	   allRow = list.size();
     ...
     %>
     <form action="admin/readpapermessage.jsp"" method="post" name="myform">
       ...
       %>
           ...
           <a href="admin/readpapermessage.jsp?page=<%="1" %>">首页 </a>&nbsp;&nbsp;
        <%
           if(currentPage>1){
        %>
           <a href="admin/readpapermessage.jsp?page=<%=currentPage-1%>">上一页</a>
        <%
           }else{
        %>
                             上一页
        ...
        %>
           <a href="admin/readpapermessage.jsp?page=<%=currentPage+1 %>">下一页 </a>
        <%
           }else{
        %>
                             下一页 
        ...
        %>
          &nbsp;&nbsp;
          <a href="admin/readpapermessage.jsp?page=<%=totalPage %>">尾页 </a>&nbsp;&nbsp;
