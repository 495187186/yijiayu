...
function checkForm() 
{
  ...
  <body>
    ...
    %>
    <form name="myform" action="AllotFileNumServlet" method="post" >
     <br>
         ...
         <tr>
            <td height="25">
               <table width="100%" height="25"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#3399cc">
                  <tr>
                      <td align="center" background="images/td_bg.gif" ><FONT color=#000000><STRONG>设置材料指派人数</STRONG></FONT></td>
                 </tr>
               </table>
            </td>
         </tr>
         <tr>
            <td bgcolor="#fffff"> 
               ...
               <table width="96%"  border="0" align="center" cellspacing="1" bgcolor="#CCCCCC" class="pt_12_hei">
                  <tr class="kbj">
                     <td colspan="2" height="30" bgcolor="#d5f1f2"><div align="center">当前每篇材料的指派人数上限为<%=allotnum.getAllotNum() %>人</div></td>
                  </tr>
                  <tr class="kbj">
