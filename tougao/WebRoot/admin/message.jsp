...
<html>
  ...
  <body>
     <%
         ...
         DocReviewed message=(DocReviewed)session.getAttribute("message");
         String []s={"优","良","中","差"};
     %>
            ...
            <td bgcolor="#fffff"> 
               ...
               <table width="96%"  border="0" align="center" cellspacing="1" bgcolor="#CCCCCC" class="pt_12_hei">
                  <tr class="kbj">
                     ...
                     <td width="56%" bgcolor="#d5f1f2" align="center"><%=message.getDocName() %></td>
                     <td width="14%" height="30" bgcolor="#d5f1f2"><div align="center">材料类型</div></td>
                     <td width="16%" bgcolor="#d5f1f2" align="center"><%=message.getDocType().equals("0")?"学校建设":"教学项目" %></td>
                  </tr>
                  <tr class="kbj">
                     ...
                     <td width="14%" height="30" bgcolor="#d5f1f2"><div align="center">材料等级</div></td>
                     <td width="16%" bgcolor="#d5f1f2" align="center"><%=s[Integer.parseInt(message.getDocLevel())] %></td>
                  </tr>
               </table>
               <br>
               <table width="96%"  border="0" align="center" cellspacing="1" bgcolor="#CCCCCC" class="pt_12_hei">
                  ...
                  <tr class="kbj">
                     ...
                     <td width="40%" bgcolor="#d5f1f2" align="center"><a href="DownReviewFileServlet?FileId=<%=message.getDocReviewedId() %>"><%=message.getDiskName() %></a></td>
                  </tr>
                  <tr bgcolor="#E4F3F8" class="kbj">
                     <td width="14%" height="30" bgcolor="#d5f1f2"><div align="center">留言内容</div></td>
                     <td colspan="3" bgcolor="#d5f1f2">　 
                        <textarea name = "info" style = "height:200px;width:500px;"/><%=message.getDocMessage()==null?"":message.getDocMessage() %></textarea> 
                     </td>
                  </tr>
             </table>
