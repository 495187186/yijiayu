...
function checkForm() 
{
  ...
  <body>
      <form name="deleteuser" action="DeleteUserServlet" method="post" >
      <br>
         ...
         <tr>
            <td height="25">
               <table width="100%" height="25"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#3399cc">
                  <tr>
                      <td align="center" background="images/td_bg.gif" ><FONT color=#000000><STRONG>删除用户</STRONG></FONT></td>
                 </tr>
               </table>
            </td>
         </tr>
