  ...
  <body>
     ...
     <script language="JavaScript">
      function Redirect(x)
       {
        //获取一级菜单长度 
        var select1_len = document.addstudent.college.options.length; 
        //把一级菜单都设为数组 
   ...
   %>     
		...
		{
			document.addstudent.major.options[p]=new Option(select1[x][p].text,select1[x][p].value);
		}
			document.addstudent.major.options[0].selected = true ;
    } 
        
     </script>  
     
     <br/>
     <form name="addstudent" action="AddStudentServlet" method="post">
           ...
           <td bgcolor="#fffff">
               ...
               <table align="center" cellspacing="1" cellSpacing=0 width="96%" bgcolor="#CCCCCC" border=0>
                   ...
                   <tr>
                       ...
                       <td bgcolor="#d5f1f2" height="30" width="80%">&nbsp;
                          <select name="college" onChange="Redirect(document.addstudent.college.options.selectedIndex)">
                              <option value="" selected>--------请选择--------</option>
                                 <%
                                   for(int i=0;i<collegeList.size();i++){
                                 %>
                                   <option value="<%=collegeList.get(i).getCollegeName() %>" ><%=collegeList.get(i).getCollegeName() %> </option>
                                 <%
                                    }
                                 %>
                          </select>
                   ...
                   <tr>
                       ...
                       <td bgcolor="#d5f1f2" height="30" width="80%">
                          ...
                          <FONT color=#ff0000>*</FONT>（注:入学时间格式如2014-01）
                       </td>
                   </tr>
               ...
               <table  align="center" cellspacing="1" cellSpacing=0 width="96%" bgcolor="#CCCCCC" border=0>
                   <tr>
                       ...
                       <td bgcolor="#d5f1f2" height="30" width="80%">
                          &nbsp;<input type="text" name="teacher" value="" size="27" />
