...
<script language="JavaScript">
	...
	function chosen(){
		...
		var listLength2 = document.getElementById("fileList2").options.length;
		var i,j;
		if(listLength1<=0||listLength1>1||listLength2<=0){
		   ...
		   {
    		   document.getElementById("fileList2").options[j].selected = true;
		   }
		   return true;
		}
  	      ...
  	      if(e1.options[i].selected){
             ...
             if(n==0){
                ...
                if(m==0){
                   ...
                   document.getElementById("file2").value = parseInt(document.getElementById("file2").value)+1; 
                }else{
                   window.alert("重复选择该材料！");
                   return false;
                }
             }
 	        }
             ...
             e2.remove(i);
  	         ...
  	         if(n==0){
 	            ...
 	            if(document.getElementById("expert2").value<0){
 	              ...
 	              document.getElementById("file2").value = parseInt(document.getElementById("file2").value)-1;
 	              if(document.getElementById("file2").value<0){
 	                document.getElementById("file2").value=0;
  	              }
  ...
  <body>
    <%
        ...
        List<AdminFile> fileList=adminfileDao.findSelectFile("1","1");//可指派:开放且定稿费
    ...
    %>
    <form action="FileAllocationServlet" method="post" name="myform" onSubmit="return chosen()">
         ...
         <tr>
            <td height="25">
               <table width="100%" height="25"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#3399cc">
                  <tr>
                      <td align="center" background="images/td_bg.gif" ><FONT color=#000000><STRONG>指派材料评审专家</STRONG></FONT></td>
                  </tr>
               </table>
            </td>
        </tr>
            ...
            <td>
               <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
                  <tr class="kbj" bgcolor="#d5f1f2" align="center">
                      ...
                      <td width="12%" height="260" >
                         <p>分配材料(<input type="text" size="3" name="file2" value="0" id="file2" style="border-style: none; background-color: #d5f1f2; width: 10px;">)篇</p>
                          
                         <div align="center" >
                            <select name="fileList2" size="10" style="width:80px ; height:190px" multiple></select>
                      ...
                      <td width="10%" align="center">
                         <br>
                         <p>
                         <input type="button" value=">>> " onClick="moveOption(document.getElementById('fileList1'), document.getElementById('fileList2'), 1, 1)"/>
                         <input type="button" value="<<< " onClick="moveOption(document.getElementById('fileList1'), document.getElementById('fileList2'), 0, 1)"/>
                         </p>
                      </td>
                      <td width="36%" height="260" >
                         <p>备选材料共(<input type="text" size="3" name="file1" value="<%=fileList.size() %>" id="file1" style="border-style: none; background-color: #d5f1f2; width: 10px;">)篇</p>
                          
                         <div align="center" >
                            <select name="fileList1" size="10" style="width:350px ; height:190px" multiple>
                               <% 
                                  for(int i=0;i<fileList.size();i++){
                                     adminfile=fileList.get(i);
                                  
                               %>
                               <option value="<%=adminfile.getFileId() %>" style="background-color:#FFFFFF; color:black">[<%=adminfile.getFileId() %>]<%=adminfile.getFileName() %>(已指派<%=adminfile.getPersonNum() %>人)</option>
                               <%
                                    }
                               %>
                            </select>
