         ...
         <tr>
            <td bgcolor="#fffff"> 
               ...
               <table width="96%"  border="0" align="center" cellspacing="1" bgcolor="#CCCCCC" class="pt_12_hei">
                  ...
                  <tr class="kbj">
                     <td width="50%" height="30" bgcolor="#d5f1f2"><div align="center">超级管理员软件使用说明书</div></td>
                     <td width="30%" height="30" bgcolor="#d5f1f2"><div align="center">6.40M</div></td>
                     <td width="20%" height="30" bgcolor="#d5f1f2">
                        <div align="center">
                           <img height="16" width="16" src="images/download.png"><a href="DownHelpFileServlet?FileName=<%="adminhelp.doc" %>">下载</a>
                        </div>
                     </td>
                  </tr>
               </table>
