...
function checkForm() 
{
  ...
  <body>
    <br/>
     <form name="addexpert"  action="AddExpertServlet" method="post">
           ...
           <td bgcolor="#fffff">
               ...
               <table align="center" cellspacing="1" cellSpacing=0 width="96%" bgcolor="#CCCCCC" border=0>
                   ...
                   <tr>
                       ...
                       <td bgcolor="#d5f1f2" height="30" width="80%">
                          &nbsp;<input type="text" name="nation" value="" size="27" />
                          <FONT color=#ff0000>*</FONT>
                       </td>
                   </tr>
                   <tr>
                       ...
                       <td bgcolor="#d5f1f2" height="30" width="80%">
                          &nbsp;<input type="text" name="birthday" value="" size="27"/>
                          <FONT color=#ff0000>*</FONT>（注:出生日期格式如2014-01-01）
                       </td>
                   </tr>
               ...
               <table  align="center" cellspacing="1" cellSpacing=0 width="96%" bgcolor="#CCCCCC" border=0>
                   ...
                   <tr>
                       ...
                       <td bgcolor="#d5f1f2" height="30" width="80%">
                          &nbsp;<input type="text" name="department" value="" size="27" />
