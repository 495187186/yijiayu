  ...
  <body>
    ...
    %>
       ...
       %>
           ...
           <a href="expert/main.jsp?page=<%="1" %>">首页 </a>&nbsp;&nbsp;
        <%
           if(currentPage>1){
        %>
           <a href="expert/main.jsp?page=<%=currentPage-1%>">上一页</a>
        <%
           }else{
        %>
                             上一页
        ...
        %>
           <a href="expert/main.jsp?page=<%=currentPage+1 %>">下一页 </a>
        <%
           }else{
        %>
                             下一页 
        ...
        %>
          &nbsp;&nbsp;
          <a href="expert/main.jsp?page=<%=totalPage %>">尾页 </a>
       <%
        }
       %>
       </center>
