...
function checkForm() 
{
  ...
  <body>
     <%
       ...
       list = papermessageDao.findReadMessage(no,"0");//查询该用户的未读留言
	   allRow = list.size();
     ...
     %>
     <form action="student/unreadpapermessage.jsp"" method="post" name="myform">
       ...
       %>
           ...
           <a href="student/unreadpapermessage.jsp?page=<%="1" %>">首页 </a>&nbsp;&nbsp;
        <%
           if(currentPage>1){
        %>
           <a href="student/unreadpapermessage.jsp?page=<%=currentPage-1%>">上一页</a>
        <%
           }else{
        %>
                             上一页
        ...
        %>
           <a href="student/unreadpapermessage.jsp?page=<%=currentPage+1 %>">下一页 </a>
        <%
           }else{
        %>
                             下一页 
        ...
        %>
          &nbsp;&nbsp;
          <a href="student/unreadpapermessage.jsp?page=<%=totalPage %>">尾页 </a>&nbsp;&nbsp;
