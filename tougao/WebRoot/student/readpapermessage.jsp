...
<%@page import="com.test.tougao.dao.PaperMessageDao"%>
<%@page import="com.test.tougao.entity.PaperMessage"%>
<%
...
function checkForm() 
{
  ...
  <body>
    <%
       ...
       String strPage;
       List<PaperMessage> list = null; 
       list = papermessageDao.findReadMessage(no,"1");//查询该用户的未读留言
	   allRow = list.size();
     ...
     %>
     <form action="student/readpapermessage.jsp"" method="post" name="myform">
		  ...
		  <tr>
			 <td height="25">
			    <table width="100%" height="25" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#3399cc">
				   <tr>
                      <td background="images/td_bg.gif" height=25 align="center"><FONT color=#000000><STRONG>已读留言列表</STRONG></FONT></td>
                  </tr>
			   </table>	
			 </td>
		 </tr>	
			   ...
			   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
				  ...
				  <%
				      for(int i=start;i<((start+pageSize)>allRow?allRow:(start+pageSize));i++)
                         {
                            PaperMessage obj = (PaperMessage)list.get(i);                           
                            if(i%2==0){
				  ...
				  %> 
					   ...
					   <td width="10%" height="30"><div align="center"><%=obj.getPaperWriter() %></div></td>
					   <td width="15%" height="30"><div align="center"><%=obj.getUploadTime().substring(0,obj.getUploadTime().length()-2) %></div></td>
				       <td width="20%" height="30"><div align="center"><a href="PaperMessageServlet?Id=<%=obj.getPaperMessageId() %>"><%=obj.getMessageName() %></a></div></td>		
       ...
       %>
           ...
           <a href="student/readpapermessage.jsp?page=<%="1" %>">首页 </a>&nbsp;&nbsp;
        <%
           if(currentPage>1){
        %>
           <a href="student/readpapermessage.jsp?page=<%=currentPage-1%>">上一页</a>
        <%
           }else{
        %>
                             上一页
        ...
        %>
           <a href="student/readpapermessage.jsp?page=<%=currentPage+1 %>">下一页 </a>
        <%
           }else{
        %>
                             下一页 
        ...
        %>
          &nbsp;&nbsp;
          <a href="student/readpapermessage.jsp?page=<%=totalPage %>">尾页 </a>&nbsp;&nbsp;
